...
contract DonnyRound is Ownable, ReentrancyGuard {
    ...
    function settleRound() external nonReentrant {
        ...
        emit RoundSettled(firstPlace, secondPlace, thirdPlace, firstPrize, secondPrize, thirdPrize, donationPool);
    }
     ...
     */
    function getTopPlayers(uint256 topN)
        external
        view
        returns (address[] memory addresses, uint256[] memory tapCounts)
    {
